...
# Last modified: 2023-07-30T09:49:33+0200
...
if [ $DIFFRESULT -eq 1 ]; then
    ...
    curl --silent -O --output-dir repo http://pkg.freebsd.org/freebsd:13:x86:64/quarterly/packagesite.txz
    curl --silent -O --output-dir repo http://pkg.freebsd.org/freebsd:13:x86:64/quarterly/meta.conf
    curl --silent -O --output-dir repo http://pkg.freebsd.org/freebsd:13:x86:64/quarterly/meta.txz
